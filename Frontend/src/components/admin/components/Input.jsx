    ...
    <div className={`space-y-1.5 w-full ${className}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full bg-[#0c0b10] border rounded-xl p-3 text-xs text-white placeholder-gray-600 focus:outline-none focus:border-[#ec4899] focus:ring-1 focus:ring-[#ec4899] transition-all ${
            Icon ? "pl-10" : "pl-3.5"
