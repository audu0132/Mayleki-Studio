...
const EmptyState = ({
  ...
  return (
    <div className={`flex flex-col items-center justify-center p-12 text-center bg-[#111827] border border-white/8 rounded-2xl shadow-xl space-y-4 max-w-lg mx-auto ${className}`}>
